...
SharedPreferences pref;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        MarkerPoints.add(fStation);
        String lats,longs;
        lats=pref.getString("lats",null);
        longs=pref.getString("longs",null);
        LatLng now;
        if (lats!=null) {
             now = new LatLng(Double.valueOf(lats),
                    Double.valueOf(longs));
            MarkerPoints.add(now);
           // googleMap.addMarker(new MarkerOptions().position(now).title("Your current location").snippet("here").icon(BitmapDescriptorFactory.fromResource(R.drawable.gasb)));
        ...
        LatLng mDefaultLocation = new LatLng(-1.2921,36.8219);
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            for (int i = 0; i < result.size(); i++) {
                ...
                lineOptions.width(5);
                lineOptions.color(R.color.purple);
