package stylist.com.glamhub.fireb;
...
import stylist.com.glamhub.NotificationListener;
import stylist.com.glamhub.R;

public class Fireb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fireb);
        ...
        editTextEmail.setText(sharedPreferences.getString(Constants.UNIQUE_ID,null));
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!isRegistered()) {
                    ...
                    //displaying a toast
                    Toast.makeText(Fireb.this, "Already registered...", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void registerDevice() {
        ...
        Toast.makeText(Fireb.this, uniqueId+"", Toast.LENGTH_SHORT).show();
        SharedPreferences sharedPreferences = getSharedPreferences(Constants.SHARED_PREF, MODE_PRIVATE);
    ...
    private void sendIdToServer(final String uniqueId) {
        ...
        StringRequest req = new StringRequest(Request.Method.POST, Constants.REGISTER_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response.trim().equalsIgnoreCase("success")) {
                            ...
                            Toast.makeText(Fireb.this, "Registered successfully", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(Fireb.this, "Choose a different email", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                Log.e("getParams: ",uniqueId+"\t"+email );
                return params;
            }
        };
